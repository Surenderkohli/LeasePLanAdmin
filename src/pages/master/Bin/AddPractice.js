...
import data from "../../../data/master/Bin/addPractice.json";
...
export default function AddPractice() {
  ...
  const addPractice=async ()=>{
    ...
    try {
      await instance({
        url: "/practice/upload-practice",
        method: "POST",
        data:formData,
        headers:{'Content-Type': 'multipart/form-data' }
      },).then((res) => {
        toast.success('Practice Added Sucessfully', {
          position: "top-right",
          autoClose: 2000,
      ...
      toast.error('Something Went Wrong. Please Fill All the Details', {
        position: "top-right",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
