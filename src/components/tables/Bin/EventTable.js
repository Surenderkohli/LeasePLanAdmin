...
import practiceInfo from "../../../data/master/Bin/eventSection.json";
        ...
        <Tbody className="mc-table-body even">
          {currentItems?.map((item, index) => (
            <Tr key={index}>
              ...
              <Td title={item?.eventDateAndTime}>{item?.eventDateAndTime}</Td>
              <Td>
                <Box className="mc-table-action">
                  <Anchor
                    href={`/editevent?query_id=${item?._id}?title=${item?.en?.title}`}
                    title="Edit"
